            ...
            <div className="max-w-2xl mx-auto px-4 py-8 space-y-8 pb-16">
                ...
                <div className="bg-[#16213e] rounded-2xl p-5 border border-white/5">
                    <p className="text-gray-400 text-sm leading-relaxed">
                        Last updated: March 2026. By using SecureVault, you agree to these Terms and Conditions.
                        SecureVault is an independent software project operated by its developer. If you do not agree, please do not use the app.
                    </p>
                </div>

                <Section title="Eligibility">
                    <p>You must be 18 years of age or older to use SecureVault. By accessing the app, you represent that you meet this requirement.</p>
                </Section>

                <Section title="License to Use">
                    <p>SecureVault is provided under a limited, personal, non-exclusive, non-transferable license. You may use the app for your private, personal use only. All rights in the app's code, content, and design remain the property of the developer.</p>
                </Section>

                <Section title="Your Data &amp; Your Vault">
                    <ul>
                        <li>You retain full ownership of everything you store in SecureVault.</li>
                ...
                <Section title="Usage Restrictions">
                    <p>You agree not to use SecureVault for any unlawful or abusive purposes, including:</p>
                    <ul>
                ...
                <Section title="Modifications &amp; Termination">
                    <p>We may update, modify, suspend, or discontinue SecureVault (or any feature) at any time without notice. We may also change these Terms from time to time; the latest version will always be posted in the app. Continued use after changes implies acceptance of the new terms.</p>
                </Section>

                <Section title="No Warranty">
                    <p>SecureVault is provided <strong className="text-white">"as is"</strong>, without any express or implied warranty. We do not guarantee that the app will be error-free or uninterrupted. To the fullest extent allowed by law, the developer and contributors disclaim all warranties, including merchantability, fitness for a particular purpose, and non-infringement.</p>
                </Section>

                <Section title="Limitation of Liability">
                    <p>You use SecureVault at your own risk. The developer will not be liable for any damages, losses of data, or other harm arising from your use of the app — including any loss of content due to forgotten passwords, device failure, or any other cause — even if we have been advised of the possibility of such damage.</p>
                </Section>
